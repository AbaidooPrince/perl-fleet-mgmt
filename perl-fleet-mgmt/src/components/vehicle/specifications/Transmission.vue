    ...
    <v-card-text>
      <v-row>
        <v-col cols="12" md="6" class="pb-0 ">
              <label>Transmission Summary<v-icon v-tippy title="Measurement of the widest part of the vehicle" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-text-field
              v-model="form.transmissionSummary"
              dense
              outlined
              >
        ...
        <v-col cols="12" md="6" class="pb-0">
              <label>Transmission Brand<v-icon v-tippy title="" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-text-field
              v-model="form.transmissionBrand"
              dense
              outlined
              >
              <template v-slot:append>
        ...
        <v-col cols="12" md="6" class="pb-0 pt-0">
              <label>Transmission Type <v-icon v-tippy title="" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-select
        ...
        <v-col cols="12" md="6" class="pb-0 pt-0">
              <label>Transmission Gears<v-icon v-tippy title="" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-text-field
              type="number"
              v-model="form.transmissionGears"
              dense
              outlined
              >
              <template v-slot:append>
