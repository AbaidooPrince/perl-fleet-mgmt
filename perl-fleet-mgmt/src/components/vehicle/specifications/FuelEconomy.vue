    ...
    <v-card-text>
      <v-row>
        <v-col cols="12" md="6" class="pb-0">
              <label>EPA City<v-icon v-tippy title="Measurement of the widest part of the vehicle" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-text-field
              v-model="form.epaCity"
              dense
              outlined
              >
              </v-text-field>
        ...
        <v-col cols="12" md="6" class="pb-0">
              <label>EPA Highway<v-icon v-tippy title="" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-text-field
              v-model="form.epaHighway"
              dense
              outlined
              >
              </v-text-field>
        ...
        <v-col cols="12" md="6" class="pb-0 pt-0">
              <label>EPA Combined<v-icon v-tippy title="" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-text-field
              v-model="form.epaCombined"
              dense
              outlined
              >
              </v-text-field>
