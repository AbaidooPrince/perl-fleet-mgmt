    ...
    <v-card-text>
      <v-row>
        <v-col cols="12" md="6" class="pb-0">
              <label>Curb Weight <v-icon v-tippy title="Measurement of the widest part of the vehicle" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-text-field
        ...
        <v-col cols="12" md="6" class="pb-0">
              <label>Gross Vehicle Weight Rating <v-icon v-tippy title="" small class="mb-1">mdi-help-circle-outline</v-icon></label>
              <v-text-field
              v-model="form.grossVehicleWeight"
              dense
              outlined
              >
              <template v-slot:append>
